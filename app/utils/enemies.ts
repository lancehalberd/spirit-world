...
function moveEnemyProper(state: GameState, enemy: Enemy, dx: number, dy: number, movementProperties: MovementProperties): {mx: number, my: number} {
    ...
    movementProperties.canSwim = !!movementProperties.canSwim || !!(isCurrentlyFlying || enemy.canSwim);
    movementProperties.canMoveInLava = !!movementProperties.canMoveInLava || !!(isCurrentlyFlying || enemy.canMoveInLava);
