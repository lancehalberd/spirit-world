    ...
    options: [
        {
            ...
            text: [
                ...
                `,
                `The Spirit King will request your help to defeat the Spirit Beasts, I'm certain of it.
                ...
                `Remember to check your map if you are ever uncertain of where to go.`,
                `I know you have many questions, but we will have to talk more later.`
            ],
        },
        {
            logicCheck: {
            ...
            isExclusive: true,
            text: [
                `I'm impressed that you've made it here already!
