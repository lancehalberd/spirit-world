...
const stoneRailings1: TileSource = {
    ...
    behaviors: {
        '0x0': { ...baseRailBehavior, solid: topAndLeftRailMask },
        '1x0': { ...baseRailBehavior, solid: topRailMask },
        '2x0': { ...baseRailBehavior, solid: topAndRightRailMask },
        '3x0': { ...baseRailBehavior, solid: rightRailMask },
        '5x0': { ...baseRailBehavior, solid: leftRailMask },
        '0x1': { ...baseRailBehavior, solid: leftRailMask },
        '2x1': { ...baseRailBehavior, solid: rightRailMask },
        '3x1': { ...baseRailBehavior, solid: rightRailMask },
        '5x1': { ...baseRailBehavior, solid: leftRailMask },
        '0x2': { ...baseRailBehavior, solid: bottomAndLeftRailMask },
        '1x2': { ...baseRailBehavior, solid: bottomRailMask },
        '2x2': { ...baseRailBehavior, solid: bottomAndRightRailMask },
...
const stoneRailings2: TileSource = {
    ...
    source: requireFrame('gfx/tiles/stonebuildingtileset.png', {x: 0, y: 0, w: 256, h: 96}),
    behaviors: {
        '6x0': { ...baseRailBehavior, solid: topAndLeftRailMask },
        '7x0': { ...baseRailBehavior, solid: topRailMask },
        '8x0': { ...baseRailBehavior, solid: topRailMask },
        '9x0': { defaultLayer: 'floor2', ledges: {up: true} },
        '10x0': { ...baseRailBehavior, solid: topAndRightRailMask },

        '6x1': { defaultLayer: 'floor2', ledges: {left: true} },
        '10x1': { defaultLayer: 'floor2', ledges: {right: true} },

        '6x2': { ...baseRailBehavior, solid: leftRailMask },
        '10x2': { ...baseRailBehavior, solid: rightRailMask },
        '6x3': { ...baseRailBehavior, solid: leftRailMask },
        '10x3': { ...baseRailBehavior, solid: rightRailMask },

        '6x4': { ...baseRailBehavior, solid: bottomAndLeftRailMask },
        '7x4': { ...baseRailBehavior, solid: bottomRailMask },
        '8x4': { ...baseRailBehavior, solid: bottomRailMask },
        '9x4': { defaultLayer: 'floor2', ledges: {down: true} },
        '10x4': { ...baseRailBehavior, solid: bottomAndRightRailMask },

        '6x5': { defaultLayer: 'field', solid: BITMAP_TOP_6},
        '7x5': { defaultLayer: 'field', solid: BITMAP_TOP_6},
        '8x5': { defaultLayer: 'field', solid: BITMAP_TOP_6},
        '9x5': { defaultLayer: 'field', solid: BITMAP_TOP_6},
...
const stoneWallTiles: TileSource = {
    ...
    behaviors: {
        ...
        '5x5': { ...southernWallBehavior, solid: BITMAP_TOP_6},
    },
    tileCoordinates: [
