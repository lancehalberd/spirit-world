...
function jumpTowardsPoint(state: GameState, enemy: Enemy, {x: tx, y: ty}) {
    ...
    enemy.params.discharge = new LightningDischarge({x, y, radius: 32, damage: 4, tellDuration: 20 * duration});
